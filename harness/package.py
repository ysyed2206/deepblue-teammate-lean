...
# "deepblue" is a default include so that the bare command
#     uv run python -m harness.package
# cannot silently build a submission whose agent.py fails to import. This
# machine has no `make`, so the bare command is the one that gets typed.
DEFAULT_INCLUDES = ("weights", "deepblue")
