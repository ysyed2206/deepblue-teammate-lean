"""S1-search199: fastsearch4 + a transposition table probe/store inside qsearch.
...
# Move-ordering instrumentation. The standard quality measure is: of the nodes
# where a beta cutoff happened, what fraction cut on the FIRST move tried?
# Strong engines report 90%+; below that, ordering is leaving depth on the
# table, and with good ordering the effective branching factor approaches 2.
CUTOFFS, FIRST_CUTOFFS = 16, 17
...
class FastEngine199:
    ...
    def __init__(self) -> None:
        ...
        self.counters = np.zeros(20, dtype=np.int64)
