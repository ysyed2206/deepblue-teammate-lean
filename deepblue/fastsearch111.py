"""S1-search111: fastsearch4 + a transposition table probe/store inside qsearch.
...
def evaluate(bb, st, mg_table, eg_table, phase_table):
    ...
    # Steeper passed-pawn curve (1.5x). Scaling an already-validated term
    # rather than inventing a new one: this session's two failed eval terms
    # both had invented weights, while all four that worked took theirs from
