...
fastsearch181 (2026-09-09) = fastsearch162's SEARCH with fastsearch135's EVAL.
...
fastsearch181 (2026-09-09) = fastsearch180 + BUDGET-NEUTRAL stability timing.
...
gives it to unstable ones, leaving the average where it is.
    ...
    root move changed on the last iteration    x1.45
    unchanged for 4+ iterations                x0.72
    otherwise                                  x1.00
...
UNSTABLE_SOFT_SCALE = 1.45
STABLE_SOFT_SCALE = 0.72
STABLE_PLIES = 4
