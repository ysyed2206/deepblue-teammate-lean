"""S1-search96: fastsearch4 + a transposition table probe/store inside qsearch.
...
def evaluate(bb, st, mg_table, eg_table, phase_table):
    ...
    # (+18). The function and its constants have existed in eval_terms.py for
    # the whole project, validated, and NO shipped engine ever called it --
    # exactly the situation mobility_white_relative was in before it was
    # wired in and measured +61 Elo. Until now the evaluation had no concept
    # of rook activity at all: a rook on a closed file and a rook raking an
    # open one scored identically.
