"""S1-search143: fastsearch4 + a transposition table probe/store inside qsearch.
...
# Multi-cut. If several of the best-ordered moves all fail high at reduced
# depth, treat the node as a proven fail-high rather than paying for the full
# search. Same reduce-then-verify family as null move, LMR and razoring, all
# of which measured positive here -- unlike ProbCut and singular extensions,
# which pay a separate verification search and both lost.
