"""S1-search136: fastsearch4 + a transposition table probe/store inside qsearch.
...
# 24 bits = 16M entries = 304 MB against a 2048 MB cap; measured +11.6 +/- 32
# over 300 games on its own -- positive, unresolved, and with no mechanism by
# which a larger table makes the engine choose worse moves (its only cost is
# TLB pressure, which that 300-game result already prices in).
TT_BITS = 24
TT_SIZE = 1 << TT_BITS
