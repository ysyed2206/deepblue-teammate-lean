"""S1-search53: fastsearch4 + a transposition table probe/store inside qsearch.
...
# Counter-move heuristic (reused from fastsearch46, built/reviewed earlier
# tonight but never given a test slot before the mate-score bug took
# priority). Ordered above history, below killers.
ORDER_COUNTER = 1 << 19
