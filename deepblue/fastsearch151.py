"""S1-search151: fastsearch4 + a transposition table probe/store inside qsearch.
...
def evaluate(bb, st, mg_table, eg_table, phase_table):
    ...
    # Steeper curve: 143cp on the seventh rather than 95. Round 73 traded a
    # pawn one square from queening for an ordinary pawn.
...
# into king+bishop vs king, and DRAW_SCORE 0 marked that as neutral rather
# than a failure.
