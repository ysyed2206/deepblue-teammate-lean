"""S1-search147: fastsearch4 + a transposition table probe/store inside qsearch.
...
def evaluate(bb, st, mg_table, eg_table, phase_table):
    ...
    # Steeper passed-pawn curve: 143cp on the seventh rank rather than 95.
    #
    # Round 73 (2026-09-08, drawn by repetition): we held a passed pawn on d2,
    # one square from queening, and traded it for White's c5 pawn via
    # 29...Ne4 30.Qd3 Nxc5 31.Qxd2. Our evaluation scored that exchange at
    # only -63 -- losing d2 (100 material + 95 passed bonus) against winning
    # c5 (100 + 32) -- because a pawn one move from becoming a queen is priced
    # below a single pawn of material.
    #
    # A steeper curve was tried once before and lost, but inside a BUNDLE, so
    # nothing established whether this term was the part that lost. Tested on
    # its own here.
