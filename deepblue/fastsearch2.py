"""S1-search2: search1 plus Principal Variation Search (PVS) only.
...
No aspiration windows, pruning, reductions, SEE or null move are added here.
Keeping PVS isolated lets the paired test answer whether it actually buys
search efficiency in Deep Blue rather than assuming another engine's result
transfers.
"""
...
NODES, GEN, MAKE, CHECK, EVAL, TTPROBE, TTHIT, QNODES, ORDER = 0, 1, 2, 3, 4, 5, 6, 7, 8
