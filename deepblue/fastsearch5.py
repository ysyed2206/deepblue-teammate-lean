"""S1-search5: PVS + conservative RFP + conservative Null-Move Pruning.
...
This variant adds NMP on top of search4.  The implementation is deliberately
small and conservative: non-PV nodes, not in check, sufficient non-pawn
material, no consecutive null, static eval >= beta, and a fixed R=3.  Null
subtrees suppress history-dependent repetition adjudication because a null move
is not a legal game move.

No aspiration windows, LMR, SEE, futility or IIR are present.
"""
