"""S1-search125: fastsearch4 + a transposition table probe/store inside qsearch.
...
from deepblue.eval_terms import (
    ...
    king_safety_graded_white_relative,
    SHIELD_ADVANCED_PENALTY,
    SHIELD_MISSING_PENALTY,
...
def evaluate(bb, st, mg_table, eg_table, phase_table):
    ...
    extra += king_safety_graded_white_relative(bb, phase, _TOTAL_PHASE,
                                              SHIELD_ADVANCED_PENALTY, SHIELD_MISSING_PENALTY)
