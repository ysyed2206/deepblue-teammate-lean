"""S1-search61: fastsearch4 + a transposition table probe/store inside qsearch.
...
# Texel-tuned tables (v2, correctly fitted -- see tuned_eval_v2's own
# docstring for the fit itself: scale anchored to the shipped evaluation,
# fitted as a residual against passed-pawns + king-safety rather than
# absorbing their signal). Built and measured against the Lichess teacher
# data tonight (+27.72% relative validation loss vs the untuned S0 tables)
# but never before run through this project's actual promotion gate --
# paired games against the current champion, not just prediction error.
from deepblue.tuned_eval_v2 import TUNED_EG_TABLE, TUNED_MG_TABLE  # noqa: E402

MG_TABLE = TUNED_MG_TABLE
EG_TABLE = TUNED_EG_TABLE
