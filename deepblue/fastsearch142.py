"""S1-search142: fastsearch4 + a transposition table probe/store inside qsearch.
...
# far to REDUCE. Standard in modern engines. Free at runtime -- it reuses data
# already in memory. Measured on 135 as +59 then -30 over two runs: unresolved
# rather than refuted, which is why it is being retested rather than dropped.
