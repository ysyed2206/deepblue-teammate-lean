"""S1-search40: fastsearch4 + a transposition table probe/store inside qsearch.
...
# Texel-tuned tables replace the inherited S0 values. Rebinding these module
# globals is enough: every call site in this file passes MG_TABLE/EG_TABLE
# explicitly into the evaluator, so nothing else has to change.
from deepblue.tuned_eval import SCALED_EG_TABLE, SCALED_MG_TABLE, TUNED_TEMPO_BONUS  # noqa: E402

MG_TABLE = SCALED_MG_TABLE
EG_TABLE = SCALED_EG_TABLE
