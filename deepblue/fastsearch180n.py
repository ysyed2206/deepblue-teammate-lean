"""S1-search180n: fastsearch180 with incremental NNUE evaluation (own-trained, 14.8M positions, PSN1 H128).
...
def warm_up(engine: FastEngine180n | None = None) -> None:
    if engine is None:
