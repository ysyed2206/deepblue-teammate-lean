"""S1-search110: fastsearch4 + a transposition table probe/store inside qsearch.
...
def evaluate(bb, st, mg_table, eg_table, phase_table):
    ...
    # Knight outposts. A knight that cannot be evicted by a pawn and is itself
    # pawn-defended becomes a permanent fixture in the opponent's position
    # rather than a piece that gets chased. A piece-square table cannot see
    # this at all -- it scores a knight the same on such a square as on one a
    # single tempo from being kicked.
