...
def main() -> None:
    jsonl_path = Path(r"C:\Users\uniqu\AppData\Local\Temp\deepblue-teammate-data\scratch_data\shard0\selected.jsonl")
    ...
    out_dir = Path(r"C:\Users\uniqu\AppData\Local\Temp\deepblue-teammate-data\scratch_data")
